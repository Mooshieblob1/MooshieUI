...
- **Video generation** - MiniMax H3 text-to-video, first/last frames and reference images; preset or custom model stacks, a shot timeline, [Standard and Larryvrh/LightX2V/PDD Turbo methods](docs/VIDEO.md), retained drafts with experimental 2× refinement, TeaCache, RIFE/GMFSS interpolation, a gallery player and MP4/animated-image export.
